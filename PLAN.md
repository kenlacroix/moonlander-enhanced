...
- [x] Physics sandbox: adjustable gravity selector on free-play mission select. Moon (1.62), Mars (3.72), Earth (9.81), Jupiter (24.79), Zero-G (0.0). Leaderboard keys include gravity preset.
- [x] Annotated autopilot: press A during autopilot flight to show force vectors, target pad indicator, decision labels (LATERAL CORRECTION, DESCENT, FINAL APPROACH, HOVER), PID error, altitude zone markers.
